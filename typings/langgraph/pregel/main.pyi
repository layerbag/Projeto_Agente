...
from langgraph.types import All, CachePolicy, Checkpointer, Command, Durability, GraphOutput, StateSnapshot, StateUpdate, StreamMode, StreamPart
...
class Pregel(PregelProtocol[StateT, ContextT, InputT, OutputT], Generic[StateT, ContextT, InputT, OutputT]):
    ...
    **Actors** read data from channels and write data to channels.
    ...
    @overload
    def stream(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: StreamMode | Sequence[StreamMode] | None = ..., print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., subgraphs: bool = ..., debug: bool | None = ..., version: Literal["v2"], **kwargs: Unpack[DeprecatedKwargs]) -> Iterator[StreamPart[StateT, OutputT]]:
        ...
    
    @overload
    def stream(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: StreamMode | Sequence[StreamMode] | None = ..., print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., subgraphs: bool = ..., debug: bool | None = ..., version: Literal["v1"] = ..., **kwargs: Unpack[DeprecatedKwargs]) -> Iterator[dict[str, Any] | Any]:
        ...
    
    def stream(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: StreamMode | Sequence[StreamMode] | None = ..., print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., subgraphs: bool = ..., debug: bool | None = ..., version: Literal["v1", "v2"] = ..., **kwargs: Unpack[DeprecatedKwargs]) -> Iterator[dict[str, Any] | Any]:
    ...
    @overload
    def invoke(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: Literal["values"] = ..., print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., version: Literal["v2"], **kwargs: Any) -> GraphOutput[OutputT]:
        ...
    
    @overload
    def invoke(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: StreamMode, print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., version: Literal["v2"], **kwargs: Any) -> list[StreamPart[StateT, OutputT]]:
        ...
    
    @overload
    def invoke(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: StreamMode = ..., print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., version: Literal["v1"] = ..., **kwargs: Any) -> dict[str, Any] | Any:
        ...
    
    def invoke(self, input: InputT | Command | None, config: RunnableConfig | None = ..., *, context: ContextT | None = ..., stream_mode: StreamMode = ..., print_mode: StreamMode | Sequence[StreamMode] = ..., output_keys: str | Sequence[str] | None = ..., interrupt_before: All | Sequence[str] | None = ..., interrupt_after: All | Sequence[str] | None = ..., durability: Durability | None = ..., version: Literal["v1", "v2"] = ..., **kwargs: Any) -> dict[str, Any] | Any:
